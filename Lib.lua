...
spawn(function()
	...
	local Name = _G.UIName.."-"..tostring(game.Players.LocalPlayer.UserId)..".settings"
		...
		if type(_G.Save) == "string" then
			_G.Save = game:service'HttpService':JSONDecode(_G.Save)
		end
		local JSON = _G.Save or {}
